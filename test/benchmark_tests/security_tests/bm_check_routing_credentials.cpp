...
static void BM_check_routing_credentials_policies_loaded_valid_values(benchmark::State& state)
{
    ...
    vsomeip_sec_client_t its_sec_client_valid =
        utility::create_uds_client(valid_uid, valid_gid, host_address);
...
static void
BM_check_routing_credentials_policies_loaded_lazy_load_invalid_values(benchmark::State& state)
{
    std::unique_ptr<vsomeip_v3::policy_manager_impl> security(new vsomeip_v3::policy_manager_impl);
...
static void
BM_check_routing_credentials_policies_loaded_lazy_load_valid_values(benchmark::State& state)
{
    std::unique_ptr<vsomeip_v3::policy_manager_impl> security(new vsomeip_v3::policy_manager_impl);
