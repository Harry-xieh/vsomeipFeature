...
static void BM_get_client_to_sec_client_mapping_valid_values(benchmark::State& state)
{
    ...
    vsomeip_sec_client_t its_sec_client_uid_gid_1 =
        utility::create_uds_client(uid_1, gid_1, host_address);
    vsomeip_sec_client_t its_sec_client_uid_gid_2 =
    ...
    vsomeip_sec_client_t its_sec_client_uid_gid_3 =
        utility::create_uds_client(uid_3, gid_3, host_address);
