...
bool lazy_load_lazy_client::init()
{
    ...
    app_->register_state_handler(
        std::bind(&lazy_load_lazy_client::on_state, this, std::placeholders::_1));
    ...
    app_->register_availability_handler(
        ...
        std::bind(&lazy_load_lazy_client::on_availability, this, std::placeholders::_1,
...
void lazy_load_lazy_client::on_state(vsomeip::state_type_e _state)
{
    ...
    if (_state == vsomeip::state_type_e::ST_REGISTERED)
    {
        ...
        app_->request_event(vsomeip_test::TEST_SERVICE_SERVICE_ID, TEST_INSTANCE_LAZY,
                            static_cast<vsomeip::event_t>(EVENT_TO_REFUSE_LAZY), its_eventgroups,
