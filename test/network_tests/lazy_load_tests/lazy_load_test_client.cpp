...
bool lazy_load_test_client::init()
{
    ...
    app_->register_state_handler(
        std::bind(&lazy_load_test_client::on_state, this, std::placeholders::_1));
    ...
    app_->register_message_handler(
        vsomeip::ANY_SERVICE, TEST_INSTANCE_LAZY, vsomeip::ANY_METHOD,
        std::bind(&lazy_load_test_client::on_message, this, std::placeholders::_1));

    app_->register_availability_handler(
        vsomeip_test::TEST_SERVICE_SERVICE_ID, vsomeip_test::TEST_SERVICE_INSTANCE_ID,
        std::bind(&lazy_load_test_client::on_availability, this, std::placeholders::_1,
    ...
    app_->register_availability_handler(vsomeip_test::TEST_SERVICE_SERVICE_ID, TEST_INSTANCE_LAZY,
...
void lazy_load_test_client::on_state(vsomeip::state_type_e _state)
{
    ...
    if (_state == vsomeip::state_type_e::ST_REGISTERED)
    {
        ...
        app_->request_event(
            vsomeip_test::TEST_SERVICE_SERVICE_ID, vsomeip_test::TEST_SERVICE_INSTANCE_ID,
            static_cast<vsomeip::event_t>(EVENT_TO_ACCEPT), its_eventgroups,
            vsomeip::event_type_e::ET_FIELD, vsomeip::reliability_type_e::RT_UNRELIABLE);
        app_->request_event(
            vsomeip_test::TEST_SERVICE_SERVICE_ID, vsomeip_test::TEST_SERVICE_INSTANCE_ID,
            static_cast<vsomeip::event_t>(EVENT_TO_REFUSE), its_eventgroups,
            vsomeip::event_type_e::ET_FIELD, vsomeip::reliability_type_e::RT_UNRELIABLE);

        app_->subscribe(vsomeip_test::TEST_SERVICE_SERVICE_ID,
                        vsomeip_test::TEST_SERVICE_INSTANCE_ID, EVENT_GROUP, vsomeip::DEFAULT_MAJOR,
