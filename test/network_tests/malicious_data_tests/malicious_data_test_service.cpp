...
{
public:
    malicious_data_test_service(struct malicious_data_test::service_info _service_info,
                                malicious_data_test::test_mode_e         _testmode)
          ...
          offer_thread_(std::bind(&malicious_data_test_service::run, this))
    {
        ...
        app_->register_state_handler(
            std::bind(&malicious_data_test_service::on_state, this, std::placeholders::_1));
        ...
        app_->register_message_handler(
            static_cast<vsomeip::service_t>(service_info_.service_id + 1u),
        ...
        app_->subscribe(service_info_.service_id, service_info_.instance_id,
                        service_info_.eventgroup_id, 0, service_info_.event_id);
    ...
    void stop()
    {
        app_->stop_offer_service(static_cast<vsomeip::service_t>(service_info_.service_id + 1u),
                                 0x1);
    ...
    {
        EXPECT_EQ(static_cast<vsomeip::service_t>(service_info_.service_id + 1u),
