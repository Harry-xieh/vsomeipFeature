...
public:
    ...
    bool init()
    {
        ...
        app_->request_event(service_info_.service_id, service_info_.instance_id,
                            service_info_.event_id, its_groups, vsomeip::event_type_e::ET_FIELD);
    ...
    void stop()
    {
        ...
        app_->unsubscribe(service_info_.service_id, service_info_.instance_id,
                          service_info_.eventgroup_id);
        app_->release_event(service_info_.service_id, service_info_.instance_id,
    ...
    void on_message(const std::shared_ptr<vsomeip::message>& _response)
    {
        ...
        its_message << "Received a notification for Event [" << std::setw(4) << std::setfill('0')
                    << std::hex << _response->get_service() << "." << std::setw(4)
                    << std::setfill('0') << std::hex << _response->get_instance() << "."
