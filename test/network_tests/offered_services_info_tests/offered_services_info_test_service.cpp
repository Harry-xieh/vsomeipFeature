...
public:
    offer_test_service(struct offer_test::service_info _service_info,
                       struct offer_test::service_info _remote_service_info)
          ...
          offer_thread_(std::bind(&offer_test_service::run, this))
    {
        ...
        app_->register_state_handler(
            std::bind(&offer_test_service::on_state, this, std::placeholders::_1));
    ...
    void offer()
    {
        ...
        app_->offer_service(service_info_.service_id,
        ...
        app_->offer_service(
            (vsomeip::service_t)(remote_service_info_.service_id + 1),
        ...
        app_->offer_service(
            (vsomeip::service_t)(remote_service_info_.service_id + 2),
        ...
        const std::vector<std::pair<vsomeip::service_t, vsomeip::instance_t>>& _services)
    {
        ...
        app_->get_offered_services_async(vsomeip::offer_type_e::OT_REMOTE,
                                         std::bind(&offer_test_service::on_offered_services_remote,
