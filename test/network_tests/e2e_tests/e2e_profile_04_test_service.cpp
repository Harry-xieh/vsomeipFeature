...
bool e2e_profile_04_test_service::init()
{
    ...
    app_->register_message_handler(
        PROFILE_04_SERVICE, PROFILE_04_INSTANCE, PROFILE_04_METHOD,
        std::bind(&e2e_profile_04_test_service::on_message, this, std::placeholders::_1));

    app_->register_message_handler(
        PROFILE_04_SERVICE, PROFILE_04_INSTANCE, PROFILE_04_SHUTDOWN,
        std::bind(&e2e_profile_04_test_service::on_message_shutdown, this, std::placeholders::_1));

    app_->register_state_handler(
        std::bind(&e2e_profile_04_test_service::on_state, this, std::placeholders::_1));

    // E2E Profile 04: Event 8001
    app_->offer_event(PROFILE_04_SERVICE, PROFILE_04_INSTANCE, PROFILE_04_EVENT,
...
{
    app_->offer_service(PROFILE_04_SERVICE, PROFILE_04_INSTANCE, PROFILE_04_MAJOR,
                        PROFILE_04_MINOR);
}

void e2e_profile_04_test_service::stop_offer()
{
    app_->stop_offer_service(PROFILE_04_SERVICE, PROFILE_04_INSTANCE, PROFILE_04_MAJOR,
                             PROFILE_04_MINOR);
}
...
void e2e_profile_04_test_service::on_message(const std::shared_ptr<vsomeip::message>& _request)
{
    ...
    if (PROFILE_04_METHOD == _request->get_method())
    {
        its_response_payload->set_data(
            responses_[counters_[PROFILE_04_METHOD] % PROFILE_O4_NUM_MESSAGES]);
...
void e2e_profile_04_test_service::on_message_shutdown(
...
int main(int argc, char** argv)
{
    ...
    responses_ = {
        {0x00, 0x50, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0xb7, 0xf4,
