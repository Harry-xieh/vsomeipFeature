...
client::client()
    : applet{"client"},
      counter_event_received{},
      counter_method_request{},
      counter_method_response{}
{}
...
void client::init()
{
    ...
    this->application->register_message_handler(
        config::SERVICE_ID, config::INSTANCE_ID, vsomeip_v3::ANY_METHOD,
    ...
    this->application->request_event(config::SERVICE_ID, config::INSTANCE_ID, config::EVENT_ID,
...
client::~client()
{
    ...
    this->application->unregister_message_handler(config::SERVICE_ID, config::INSTANCE_ID,
