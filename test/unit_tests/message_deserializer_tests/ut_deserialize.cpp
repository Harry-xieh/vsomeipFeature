...
TEST(deserialize_test, deserialize_get_available)
{
    ...
    std::unique_ptr<vsomeip_v3::deserializer> its_deserializer(new vsomeip_v3::deserializer(
        byte_array_.data(), byte_array_.size(), buffer_shrink_threshold));
...
TEST(deserialize_test, deserialize_from_uint32_omit_last_byte)
{
    ...
    const std::uint32_t uint32_3_bytes =
        vsomeip_v3::bithelper::read_uint32_be(uint32_3_bytes_array_.data());
    const std::uint32_t uint32_full =
        vsomeip_v3::bithelper::read_uint32_be(uint32_full_array_.data());
...
TEST(deserialize_test, deserialize_from_uint8_array_pointer_and_length)
{
    ...
    ASSERT_TRUE(its_deserializer->deserialize(deserialized_byte_array_.data(),
                                              deserialized_byte_array_.size()));
    ...
    std::unique_ptr<vsomeip_v3::deserializer> its_deserializer2(new vsomeip_v3::deserializer(
        byte_array_.data(), byte_array_.size(), buffer_shrink_threshold));
...
TEST(deserialize_test, look_ahead_for_uint32)
{
    ...
    const std::uint32_t uint32_1 =
        vsomeip_v3::bithelper::read_uint32_be(uint32_1_bytes_array_.data());
    const std::uint32_t uint32_2 =
        vsomeip_v3::bithelper::read_uint32_be(uint32_2_bytes_array_.data());
...
TEST(deserialize_test, deserialize_message)
{
    ...
    std::array<vsomeip_v3::byte_t, 25> byte_array_{
        byte1, byte2, byte3, byte4, 0,     0,     0,     8, byte4, byte1, byte1, byte2, byte3,
    ...
    std::unique_ptr<vsomeip_v3::deserializer>  its_deserializer2(new vsomeip_v3::deserializer(
        byte_array2_.data(), byte_array2_.size(), buffer_shrink_threshold));
...
TEST(deserialize_test, set_data_from_uint8_array_pointer_and_length)
{
    ...
    ASSERT_FALSE(its_deserializer2->deserialize(deserialized_byte_array_.data(),
                                                deserialized_byte_array_.size()));
}
