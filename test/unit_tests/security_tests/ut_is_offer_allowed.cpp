...
TEST(is_offer_allowed, check_policies_loaded)
{
    ...
    vsomeip_sec_client_t its_sec_client_valid =
        utility::create_uds_client(uid_1, gid_1, host_address);
    vsomeip_sec_client_t its_sec_client_invalid =
        utility::create_uds_client(invalid_uid, invalid_gid, host_address);
    vsomeip_sec_client_t its_sec_client_valid_uid_invalid_gid =
        utility::create_uds_client(uid_1, invalid_gid, host_address);
    vsomeip_sec_client_t its_sec_client_invalid_uid_valid_gid =
        utility::create_uds_client(invalid_uid, gid_1, host_address);
    vsomeip_sec_client_t its_sec_client_deny =
        utility::create_uds_client(deny_uid, deny_gid, host_address);
    vsomeip_sec_client_t its_sec_client_any =
        utility::create_uds_client(ANY_UID, ANY_GID, host_address);
    ...
    EXPECT_FALSE(
        security->is_offer_allowed(&its_sec_client_invalid_uid_valid_gid, service_1, instance));
    EXPECT_FALSE(
        security->is_offer_allowed(&its_sec_client_valid_uid_invalid_gid, service_1, instance));
