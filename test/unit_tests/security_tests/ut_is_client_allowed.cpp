...
TEST(is_client_allowed_test, check_policies_loaded)
{
    ...
    vsomeip_sec_client_t its_sec_client_invalid_uid =
        utility::create_uds_client(invalid_uid, gid_1, host_address);
    vsomeip_sec_client_t its_sec_client_invalid_gid =
    ...
    EXPECT_FALSE(
        its_manager->is_client_allowed(&its_sec_client_invalid_uid, service_1, instance, method));
    EXPECT_FALSE(
        its_manager->is_client_allowed(&its_sec_client_invalid_gid, service_1, instance, method));
