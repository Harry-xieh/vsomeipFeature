...
TEST(get_sec_client_to_clients_mapping, test)
{
    ...
    vsomeip_sec_client_t its_sec_client_uid_gid_alternate =
    ...
    EXPECT_FALSE(
        security->get_sec_client_to_clients_mapping(&its_sec_client_uid_gid_alternate, clients_1));
    ...
    EXPECT_TRUE(
        security->get_sec_client_to_clients_mapping(&its_sec_client_uid_gid_alternate, clients_3));
