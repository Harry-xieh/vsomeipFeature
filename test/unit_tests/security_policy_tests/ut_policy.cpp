...
TEST(security_policy_test, deserialize)
{
    ...
    std::array<vsomeip_v3::byte_t, 2> uint16_array_request_service_{request_service_byte1,
                                                                    request_service_byte2};
    std::array<vsomeip_v3::byte_t, 2> uint16_array_request_instance_low_{instance_id_low_byte1,
                                                                         instance_id_low_byte2};
    std::array<vsomeip_v3::byte_t, 2> uint16_array_request_instance_high_{instance_id_high_byte1,
                                                                          instance_id_high_byte2};
    std::array<vsomeip_v3::byte_t, 2> uint16_array_request_method_id_low_{method_id_low_byte1,
                                                                          method_id_low_byte2};
    std::array<vsomeip_v3::byte_t, 2> uint16_array_request_method_id_high_{method_id_high_byte1,
                                                                           method_id_high_byte2};

    std::uint16_t request_service =
        vsomeip_v3::bithelper::read_uint16_be(uint16_array_request_service_.data());
    std::uint16_t request_instance_low =
        vsomeip_v3::bithelper::read_uint16_be(uint16_array_request_instance_low_.data());
    std::uint16_t request_instance_high =
        vsomeip_v3::bithelper::read_uint16_be(uint16_array_request_instance_high_.data());
    std::uint16_t request_method_low =
        vsomeip_v3::bithelper::read_uint16_be(uint16_array_request_method_id_low_.data());
    std::uint16_t request_method_high =
        vsomeip_v3::bithelper::read_uint16_be(uint16_array_request_method_id_high_.data());
    ...
    auto deserialized_method_set = deserialized_service_set->second.lower_bound(
        boost::icl::interval<vsomeip_v3::instance_t>::closed(request_instance_low,
    ...
    // Check offers
    // Create uint16_t from bytes.
    std::array<vsomeip_v3::byte_t, 2> uint16_array_offer_service_{offer_service_byte1,
                                                                  offer_service_byte2};
    std::array<vsomeip_v3::byte_t, 2> uint16_array_offer_instance_low_{instance_id_low_byte1,
                                                                       instance_id_low_byte2};
    std::array<vsomeip_v3::byte_t, 2> uint16_array_offer_instance_high_{instance_id_high_byte1,
                                                                        instance_id_high_byte2};
    std::array<vsomeip_v3::byte_t, 2> uint16_array_offer_instance2_low_{instance2_id_low_byte1,
                                                                        instance2_id_low_byte2};
    std::array<vsomeip_v3::byte_t, 2> uint16_array_offer_instance2_high_{instance2_id_low_byte1,
                                                                         instance2_id_low_byte2};

    std::uint16_t offer_service =
        vsomeip_v3::bithelper::read_uint16_be(uint16_array_offer_service_.data());
    std::uint16_t offer_instance_low =
        vsomeip_v3::bithelper::read_uint16_be(uint16_array_offer_instance_low_.data());
    std::uint16_t offer_instance_high =
        vsomeip_v3::bithelper::read_uint16_be(uint16_array_offer_instance_high_.data());
    std::uint16_t offer_instance2_low =
        vsomeip_v3::bithelper::read_uint16_be(uint16_array_offer_instance2_low_.data());
    std::uint16_t offer_instance2_high =
        vsomeip_v3::bithelper::read_uint16_be(uint16_array_offer_instance2_high_.data());
    ...
    boost::icl::interval_set<vsomeip_v3::instance_t>::iterator it =
        deserialized_offer_service_set->second.begin();
...
TEST(security_policy_test, serialize)
{
    ...
    std::array<vsomeip_v3::byte_t, resized_array_size> byte_array_{
        ...
        // offer_instance_idlist_byte1, offer_instance_idlist_byte2, offer_instance_idlist_byte3,
        // offer_instance_idlist_byte4, instance_id_length_byte1, instance_id_length_byte2,
        // instance_id_length_byte3, instance_id_length_byte4, instance_id_type_byte1,
        // instance_id_type_byte2, instance_id_type_byte3, instance_id_type_byte4,
...
#ifndef __QNX__
    ASSERT_TRUE(
        its_policy->deserialize_uid_gid(data_ptr_, data_size_, deserialized_uid, deserialized_gid));
#endif
    ASSERT_EQ(deserialized_uid, uid);
    ASSERT_EQ(deserialized_gid, gid);
}
