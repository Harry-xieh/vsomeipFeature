...
TEST(serialize_test, serialize_from_uint16)
{
    ...
    std::array<vsomeip_v3::byte_t, 2> uint16_array_reconstructed_num1_{
        its_serializer->get_data()[0], its_serializer->get_data()[1]};
    std::array<vsomeip_v3::byte_t, 2> uint16_array_reconstructed_num2_{
        its_serializer->get_data()[2], its_serializer->get_data()[3]};
    std::array<vsomeip_v3::byte_t, 2> uint16_array_reconstructed_num3_{
        its_serializer->get_data()[4], its_serializer->get_data()[5]};

    std::uint16_t reconstructed_num1 =
        vsomeip_v3::bithelper::read_uint16_be(uint16_array_reconstructed_num1_.data());
    std::uint16_t reconstructed_num2 =
        vsomeip_v3::bithelper::read_uint16_be(uint16_array_reconstructed_num2_.data());
    std::uint16_t reconstructed_num3 =
        vsomeip_v3::bithelper::read_uint16_be(uint16_array_reconstructed_num3_.data());
...
TEST(serialize_test, serialize_from_uint32_omit_last_byte)
{
    ...
    std::array<vsomeip_v3::byte_t, 4> uint32_array_reconstructed_num1_{
        0, its_serializer->get_data()[0], its_serializer->get_data()[1],
        its_serializer->get_data()[2]};
    std::array<vsomeip_v3::byte_t, 4> uint32_array_reconstructed_num2_{
        0, its_serializer->get_data()[3], its_serializer->get_data()[4],
        its_serializer->get_data()[5]};
    std::array<vsomeip_v3::byte_t, 4> uint32_array_reconstructed_num3_{
        0, its_serializer->get_data()[6], its_serializer->get_data()[7],
        its_serializer->get_data()[8]};

    // Create uint32_t from bytes.
    const std::uint32_t reconstructed_num1 =
        vsomeip_v3::bithelper::read_uint32_be(uint32_array_reconstructed_num1_.data());
    const std::uint32_t reconstructed_num2 =
        vsomeip_v3::bithelper::read_uint32_be(uint32_array_reconstructed_num2_.data());
    const std::uint32_t reconstructed_num3 =
        vsomeip_v3::bithelper::read_uint32_be(uint32_array_reconstructed_num3_.data());
...
TEST(serialize_test, serialize_from_uint32_dont_omit_last_byte)
{
    ...
    // Create arrays to pass to bithelper.
    std::array<vsomeip_v3::byte_t, 4> uint32_array_reconstructed_num1_{
        its_serializer->get_data()[0], its_serializer->get_data()[1], its_serializer->get_data()[2],
        its_serializer->get_data()[3]};
    std::array<vsomeip_v3::byte_t, 4> uint32_array_reconstructed_num2_{
        its_serializer->get_data()[4], its_serializer->get_data()[5], its_serializer->get_data()[6],
        its_serializer->get_data()[7]};
    std::array<vsomeip_v3::byte_t, 4> uint32_array_reconstructed_num3_{
        its_serializer->get_data()[8], its_serializer->get_data()[9],
