...
void offered_services_request_command::serialize(std::vector<byte_t>& _buffer,
...
void offered_services_request_command::deserialize(const std::vector<byte_t>& _buffer,
                                                   error_e&                   _error)
{
