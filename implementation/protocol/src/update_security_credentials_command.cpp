...
void update_security_credentials_command::serialize(std::vector<byte_t>& _buffer,
...
void update_security_credentials_command::deserialize(const std::vector<byte_t>& _buffer,
                                                      error_e&                   _error)
{
...
void update_security_credentials_command::set_credentials(
