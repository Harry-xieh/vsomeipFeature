...
{
    size_t its_size(
        size_ + COMMAND_HEADER_SIZE + sizeof(_register_event.get_service())
        + sizeof(_register_event.get_instance()) + sizeof(_register_event.get_event())
        + sizeof(_register_event.get_event_type()) + sizeof(_register_event.is_provided())
        + sizeof(_register_event.get_reliability()) + sizeof(_register_event.is_cyclic())
        + sizeof(_register_event.get_num_eventgroups())
