...
void distribute_security_policies_command::serialize(std::vector<byte_t>& _buffer,
                                                     error_e&             _error) const
{
    ...
    if (payload_.empty())
    { // No policy data (--> set_payloads was not called)
...
void distribute_security_policies_command::deserialize(const std::vector<byte_t>& _buffer,
                                                       error_e&                   _error)
{
...
void distribute_security_policies_command::set_payloads(
