...
bool header::prepare(const std::shared_ptr<endpoint>& _endpoint, bool _is_sending,
...
void header::prepare(const boost::asio::ip::address_v4& _address, std::uint16_t _port,
                     protocol_e _protocol, bool _is_sending, instance_t _instance)
{
