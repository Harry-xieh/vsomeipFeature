...
bool virtual_server_endpoint_impl::send_to(const std::shared_ptr<endpoint_definition> _target,
...
bool virtual_server_endpoint_impl::send_error(const std::shared_ptr<endpoint_definition> _target,
                                              const byte_t* _data, uint32_t _size)
{
    (void)_target;
    (void)_data;
...
void virtual_server_endpoint_impl::add_default_target(service_t          _service,
