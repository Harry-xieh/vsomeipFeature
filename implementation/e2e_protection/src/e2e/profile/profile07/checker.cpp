            ...
            if (read_32(_buffer, its_received_counter, PROFILE_07_COUNTER_OFFSET))
            {
                ...
                if (read_32(_buffer, its_received_data_id, PROFILE_07_DATAID_OFFSET))
                {
                    ...
                    if (read_64(_buffer, its_received_crc, PROFILE_07_CRC_OFFSET))
                    {
                        ...
                        {
                            _generic_check_status =
                                e2e::profile_interface::generic_check_status::E2E_WRONG_CRC;
                            VSOMEIP_ERROR
                                << std::hex
                                << "E2E P07 protection: CRC32 does not match: calculated CRC: "
                        ...
                        else
                        {
                            ...
                            {
                                _generic_check_status =
                                    e2e::profile_interface::generic_check_status::E2E_OK;
                            }
                        }
                    }
                }
