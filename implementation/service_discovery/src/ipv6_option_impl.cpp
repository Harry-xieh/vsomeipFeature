...
ipv6_option_impl::ipv6_option_impl(const boost::asio::ip::address& _address, const uint16_t _port,
...
void ipv6_option_impl::set_address(const ipv6_address_t& _address)
{
    ...
    type_ =
        (its_address.is_multicast() ? option_type_e::IP6_MULTICAST : option_type_e::IP6_ENDPOINT);
}
...
{
    bool is_successful =
        option_impl::deserialize(_from) && length_ == VSOMEIP_SD_IPV6_OPTION_LENGTH;
