...
void application_impl::request_event(service_t _service, instance_t _instance, event_t _event,
                                     const std::set<eventgroup_t>& _eventgroups, bool _is_field)
{
    const vsomeip_v3::event_type_e its_type =
        (_is_field) ? vsomeip_v3::event_type_e::ET_FIELD : vsomeip_v3::event_type_e::ET_EVENT;
...
{
    impl_->register_state_handler([_handler](vsomeip_v3::state_type_e _state) {
...
{
    impl_->register_message_handler(
                                                     ...
                                                     subscription_handler_t _handler)
{
    ...
    impl_->register_subscription_handler(
                                                           ...
                                                           error_handler_t _handler)
{
    impl_->register_subscription_status_handler(
        ...
        [_handler](service_t _service, instance_t _instance, eventgroup_t _eventgroup,
...
void application_impl::unregister_subscription_error_handler(service_t    _service,
                                                             ...
                                                             eventgroup_t _eventgroup)
{
    impl_->unregister_subscription_status_handler(_service, _instance, _eventgroup,
                                                  ERROR_HANDLER_DUMMY_EVENT);
}
                                   ...
                                   const epsilon_change_func_t& _epsilon_change_func)
{
    ...
    impl_->offer_event(_service, _instance, _event, _eventgroups, its_type, _cycle,
                       _change_resets_cycle, true,
                       [_epsilon_change_func](const std::shared_ptr<vsomeip_v3::payload>& _lhs,
    ...
    subscription_status_handler_t _handler, bool _is_selective)
{
    ...
    impl_->register_subscription_status_handler(
        ...
        [_handler](const vsomeip_v3::service_t _service, const vsomeip_v3::instance_t _instance,
                   const vsomeip_v3::eventgroup_t _eventgroup, const vsomeip_v3::event_t _event,
...
void application_impl::get_offered_services_async(offer_type_e               _offer_type,
                                                  offered_services_handler_t _handler)
{
                                                           ...
                                                           async_subscription_handler_t _handler)
{
    ...
    impl_->register_async_subscription_handler(
        _service, _instance, _eventgroup,
        [_handler](client_t _client, vsomeip::uid_t _uid, vsomeip::gid_t _gid, bool _accepted,
...
////////////////////////////////////////////////////////////////////////////////
void application_impl::set_offer_acceptance_required(ip_address_t _address, const std::string _path,
                                                     bool _enable)
{
    (void)_address;
    (void)_path;
...
void application_impl::update_security_policy_configuration(uint32_t _uid, uint32_t _gid,
...
void application_impl::remove_security_policy_configuration(uint32_t _uid, uint32_t _gid,
                                                            security_update_handler_t _handler)
{
    (void)_uid;
    (void)_gid;
...
bool application_impl::is_selective_event(vsomeip::service_t                     _service,
